...
london = City.create(name: 'london', internet: '12gb', weather: '-5c', country: 'england', price: '1384$',
                     image: 'city_card_images/test.jpg')
london.save!

paris = City.create(name: 'paris', internet: '11gb', weather: '1c', country: 'france', price: '1384$',
                    image: 'city_card_images/test.jpg')
paris.save!

denver = City.create(name: 'denver', internet: '8gb', weather: '5c', country: 'USA', price: '1384$',
                     image: 'city_card_images/test.jpg')
denver.save!
...
chicago = City.create(name: 'chicago', internet: '19gb', weather: '-33c', country: 'USA', price: '1384$',
                      image: 'city_card_images/test.jpg')
chicago.save!

tokyo = City.create(name: 'tokyo', internet: '200gb', weather: '18c', country: 'japan', price: '1384$',
                    image: 'city_card_images/test.jpg')
tokyo.save!

seoul = City.create(name: 'seoul', internet: '300gb', weather: '17c', country: 'korea', price: '1384$',
                    image: 'city_card_images/test.jpg')
seoul.save!
